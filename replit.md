...
**Branding:** The Bcalm logo (orange graduation cap icon with "BCALM" wordmark and tagline) is displayed across the website in three placements: (1) Navbar - full logo at responsive size (35-45px height), clickable link to home; (2) Footer - full logo at 60px height above description text; (3) Sticky navigation - icon-only version (28px square) appears when quicklinks become sticky. Logo asset: attached_assets/587825421_122110881585061636_4522478478515908937_n_1763885253278.jpg.
